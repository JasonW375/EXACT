...
class setting_config:
    ...
    network = 'ymamba'
    test_data_path = '/path/to/valid_total_processed_data.h5'

    train_data_path='/path/to/random_total_processed_data.h5'
    ...
    segmentation_criterion=AbnormalSegmentationLoss()
